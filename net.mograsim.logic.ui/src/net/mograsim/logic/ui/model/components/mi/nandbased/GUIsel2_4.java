...
public class GUIsel2_4 extends SimpleRectangularSubmodelComponent
{
	...
	private void initSubmodelComponents()
	{
		...
		nandA1.moveCenterTo(20, 2.5);
		nandB1.moveCenterTo(20, 27.5);
		nandA2.moveCenterTo(20, 52.5);
		nandB2.moveCenterTo(20, 77.5);
		nandA3.moveCenterTo(20, 102.5);
		nandB3.moveCenterTo(20, 127.5);
		nandA4.moveCenterTo(20, 152.5);
		nandB4.moveCenterTo(20, 177.5);
		nandY1.moveCenterTo(65, 2.5);
		nandY2.moveCenterTo(65, 27.5);
		nandY3.moveCenterTo(65, 52.5);
		nandY4.moveCenterTo(65, 77.5);
		...
		new GUIWire(submodelModifiable, nandA1.getOutputPin(), nandY1.getInputPins().get(0), new Point(40, 12.5), new Point(40, 7.5));
		new GUIWire(submodelModifiable, nandB1.getOutputPin(), nandY1.getInputPins().get(1), new Point(40, 37.5), new Point(40, 17.5));
		new GUIWire(submodelModifiable, nandA2.getOutputPin(), nandY2.getInputPins().get(0), new Point(42.5, 62.5), new Point(42.5, 32.5));
		new GUIWire(submodelModifiable, nandB2.getOutputPin(), nandY2.getInputPins().get(1), new Point(45, 87.5), new Point(45, 42.5));
		new GUIWire(submodelModifiable, nandA3.getOutputPin(), nandY3.getInputPins().get(0), new Point(47.5, 112.5), new Point(47.5, 57.5));
		new GUIWire(submodelModifiable, nandB3.getOutputPin(), nandY3.getInputPins().get(1), new Point(50, 137.5), new Point(50, 67.5));
		new GUIWire(submodelModifiable, nandA4.getOutputPin(), nandY4.getInputPins().get(0), new Point(52.5, 162.5), new Point(52.5, 82.5));
		new GUIWire(submodelModifiable, nandB4.getOutputPin(), nandY4.getInputPins().get(1), new Point(55, 187.5), new Point(55, 92.5));
